...
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.pref.BrowsableItemPrefs.SORT_BY_ADDED;
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.pref.BrowsableItemPrefs.SORT_BY_DATE;
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.pref.BrowsableItemPrefs.SORT_BY_FILE_NAME;
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.pref.BrowsableItemPrefs.SORT_BY_NAME;
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.pref.BrowsableItemPrefs.SORT_BY_NONE;
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.pref.BrowsableItemPrefs.SORT_BY_RND;
...
import me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.addon.FermataToolAddon;
...
public class ToolBarMediator implements ToolBarView.Mediator.BackTitleFilter {
	...
	private static void onSortButtonClick(View v) {
		...
		a.getToolBarMenu().show(b -> {
			...
			addSortItem(b, R.id.tool_sort_added, R.string.latest_added, SORT_BY_ADDED, sort, m);
	...
	private static boolean sortMenuHandler(OverlayMenuItem item) {
		...
		if (itemId == R.id.tool_sort_name) {
			...
			return true;
		} else if (itemId == R.id.tool_sort_added) {
			setSortBy(adapter, SORT_BY_ADDED);
			return true;
