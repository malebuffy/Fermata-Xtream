...
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.util.Utils.createDownloader;
...
public class MainActivity extends SplitCompatActivityBase
	...
	protected FutureSupplier<MainActivityDelegate> createDelegate(AppActivity a) {
		return DeviceLicense.awaitLicensed(this).then(v -> createLicensedDelegate(a));
	}

	private FutureSupplier<MainActivityDelegate> createLicensedDelegate(AppActivity a) {
	...
	public FutureSupplier<?> uninstallControl() {
		...
		var pkgName = "me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.auto.control.dear.google.why";
