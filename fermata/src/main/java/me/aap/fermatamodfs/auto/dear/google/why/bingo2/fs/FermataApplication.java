package me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs;
...
public class FermataApplication extends NetSplitCompatApp {
	...
	private me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.service.MediaSessionCallback mediaSessionCallback;

	public static FermataApplication get() {
		return App.get();
	}

	public me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.service.MediaSessionCallback getMediaSessionCallback() {
		return mediaSessionCallback;
	}

	public void setMediaSessionCallback(me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.service.MediaSessionCallback callback) {
	...
	public void setMirroringMode(int mirroringMode) {
		...
		if (mirroringMode == 0) {
			...
			try {
				...
				var i = new Intent();
				i.setComponent(
						new ComponentName(this, "me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.auto" + ".XposedEventDispatcherService"));
