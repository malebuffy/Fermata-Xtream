...
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.addon.felex.dict.Dict.findWord;
...
import me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.addon.felex.FelexAddon;
...
import me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.addon.felex.dict.Example;
...
import me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.provider.FermataContentProvider;
...
public class FelexListView extends RecyclerView implements Closeable,
	...
	private final class DictAdapter extends Adapter<Holder>
			...
			activity.getContextMenu().show(b -> {
				...
				if (!(item instanceof Example) && !(item instanceof DictMgr)) {
					b.addItem(me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.id.edit, me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.drawable.edit,
							me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.edit).setData(dv);
				}
				b.addItem(me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.id.delete, me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.drawable.delete,
						me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.delete).setData(dv);

				if (item instanceof Dict) {
					b.addItem(me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.id.share, me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.drawable.share,
							me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.share).setData(dv);
		...
		private boolean menuHandler(OverlayMenuItem i) {
			...
			if (id == me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.id.edit) {
				var item = dv.item;
				String oldValue;
				...
				UiUtils.queryText(getContext(), me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.edit,
						me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.drawable.edit, oldValue).then(newValue -> {
				...
				String title = ctx.getString(me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.delete);
				String msg = ctx.getString(me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.delete_confirm, item.toString());
				Drawable icon = getDrawable(ctx, me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.drawable.delete);
			...
			} else if (id == me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.id.share) {
				Dict d = (Dict) dv.item;
	...
	private final class MgrContent extends Content<DictMgr, Object, MgrContent> {
		...
		CharSequence title() {
			...
			return name.isEmpty() ? getContext().getString(me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.addon_name_felex) :
					name;
		}
	...
	private final class DictItemView extends ConstraintLayout {
		...
		DictItemView(@NonNull Context ctx) {
			...
			setBackgroundResource(me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.drawable.media_item_bg);
