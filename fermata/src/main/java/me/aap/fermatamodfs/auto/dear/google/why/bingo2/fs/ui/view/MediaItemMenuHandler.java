...
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.pref.MediaPrefs.HW_ACCEL_AUTO;
...
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.pref.MediaPrefs.VIDEO_SCALE;
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.pref.PlayableItemPrefs.BOOKMARKS;
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.pref.PlayableItemPrefs.bookmarkTime;
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.ui.fragment.SettingsFragment.addAudioPrefs;
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.ui.fragment.SettingsFragment.addAutoSubPrefs;
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.ui.fragment.SettingsFragment.addDelayPrefs;
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.ui.fragment.SettingsFragment.addSubSizePrefs;
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.ui.fragment.SettingsFragment.addSubtitlePrefs;
...
import me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.lib.FileItem;
import me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.lib.FolderItem;
...
import me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.lib.MediaLib.Folders;
...
public class MediaItemMenuHandler implements OverlayMenu.SelectionHandler {
	...
	private void applyVideoScale() {
		...
		if (eng == null) return;
		MainActivityDelegate a = getMainActivity();
		VideoView vv = a.getMediaSessionCallback().getVideoView();
		if (vv != null) vv.setSurfaceSize(eng);
	}
