...
public class YoutubeKidsAddon extends YoutubeAddon {
	@NonNull
	private static final AddonInfo info = FermataAddon.findAddonInfo(YoutubeKidsAddon.class.getName());
	...
	public ActivityFragment createFragment() {
		return new YoutubeKidsFragment();
	}
}
