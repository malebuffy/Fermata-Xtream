...
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.addon.felex.FelexAddon.CACHE_FOLDER;
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.addon.felex.FelexAddon.DICT_FOLDER;
...
import me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.addon.felex.dict.DictInfo;
...
import me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.addon.felex.media.FelexItem;
import me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.addon.felex.tutor.DictTutor;
...
import me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.ui.fragment.NavToolBarMediator;
...
public class FelexFragment extends MainActivityFragment
	...
	private FelexBar felexBar;

	@Override
	public int getFragmentId() {
		return me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.id.felex_fragment;
	}
	...
	public ToolBarView.Mediator getToolBarMediator() {
		return NavToolBarMediator.getInstance();
	}
	...
	public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
		...
		felexBar = new FelexBar(this, view.findViewById(R.id.felexBar));
	...
	public void contributeToNavBarMenu(OverlayMenu.Builder builder) {
		...
		b.addItem(R.id.start_tutor, me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.drawable.record_voice, R.string.start_tutor)
		...
		if ((content instanceof DictMgr) || (content instanceof Dict)) {
			b.addItem(me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.id.refresh, me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.drawable.refresh,
					me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.refresh).setData(content);
		}
	...
	private boolean navBarMenuItemSelected(OverlayMenuItem item) {
		...
		} else if (id == me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.id.refresh) {
	...
	public void onActivityEvent(MainActivityDelegate a, long e) {
		...
		else if ((e == FRAGMENT_CONTENT_CHANGED) && (felexBar != null)) felexBar.updateVisibility();
	}
	...
	@NonNull
	FelexListView view() {
		return requireView().findViewById(R.id.felix_list_view);
	}
	...
	static final class FelexActions {
		private FelexActions() {
		}

		static void add(View v) {
