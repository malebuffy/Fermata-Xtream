package me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.vfs.sftp;
...
public class Provider extends VfsProviderBase {
	...
	protected FutureSupplier<? extends VirtualResource> addFolder(MainActivityDelegate a, VirtualFileSystem fs) {
		...
		prefs.addStringPref(o -> {
			o.store = ps;
			o.pref = HOST;
			o.title = me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.host;
			o.stringHint = "localhost";
		});
		prefs.addIntPref(o -> {
			o.store = ps;
			o.pref = PORT;
			o.title = me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.port;
			o.showProgress = false;
		});
		prefs.addStringPref(o -> {
			o.store = ps;
			o.pref = PATH;
			o.title = me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.path;
		...
		prefs.addStringPref(o -> {
			...
			o.pref = USER;
			o.stringHint = "root";
			o.title = me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.username;
		});
		prefs.addFilePref(o -> {
			o.store = ps;
			o.pref = KEY;
			o.title = me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.private_key;
		...
		prefs.addStringPref(o -> {
			o.store = ps;
			o.pref = PASSWD;
			o.title = me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.password;
			o.stringHint = "secret";
		});
		prefs.addStringPref(o -> {
			o.store = ps;
			o.pref = KEY_PASSWD;
			o.title = me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.private_key_pass;
			o.stringHint = "secret";
		});
