...
public class OverlayMenuView extends ScrollView implements OverlayMenu {
	...
	public OverlayMenuView(Context ctx, AttributeSet attrs) {
		...
		var surface = ta.getDrawable(R.styleable.OverlayMenuView_surfaceBackground);
		if (surface != null) setBackground(surface);
		else setBackgroundColor(
				ta.getColor(OverlayMenuView_android_colorBackground, Color.TRANSPARENT));
		ta.recycle();
	}
