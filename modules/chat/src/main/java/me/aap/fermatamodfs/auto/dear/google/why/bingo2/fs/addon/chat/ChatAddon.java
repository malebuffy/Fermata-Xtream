...
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.util.Utils.openUrl;
...
public class ChatAddon implements FermataFragmentAddon {
	...
	public void contributeSettings(Context ctx, PreferenceStore store, PreferenceSet set,
		...
		set.addTtsLocalePref(o -> {
			o.store = store;
			o.pref = CHAT_LANG;
			o.title = me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.lang;
			o.subtitle = me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.string_format;
			o.formatSubtitle = true;
		});
	}
