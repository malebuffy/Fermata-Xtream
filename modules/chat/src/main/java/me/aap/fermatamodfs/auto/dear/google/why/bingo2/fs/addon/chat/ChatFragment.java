package me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.addon.chat;
...
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.addon.chat.ChatListView.URL_PATTERN;
...
import me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.ui.fragment.HomeToolBar;
...
public class ChatFragment extends MainActivityFragment
	...
	public int getFragmentId() {
		return me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.id.chat_addon;
	}
	...
	public ToolBarView.Mediator getToolBarMediator() {
		return HomeToolBar.withHome(ChatToolMediator.instance);
	}
		...
		MainActivityDelegate.get(getContext()).startSpeechRecognizer(a.getGetChatLang(), false)
				.onSuccess(q -> {
					...
					if ((openPattern == null) || !lang.equals(chatLang)) {
						...
						openPattern = Pattern.compile(res.getString(
								me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.vcmd_action_open));
					}
	...
	private void releaseAudioFocus() {
		AudioManager am = (AudioManager) requireContext().getSystemService(Context.AUDIO_SERVICE);
		if (am == null) return;
		AudioManagerCompat.abandonAudioFocusRequest(am, getAudioFocusReq());
	}
	...
	private static final class FbMediator implements FloatingButton.Mediator {
		...
		public void enable(FloatingButton b, ActivityFragment f) {
			...
			b.setImageResource(me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.drawable.record_voice);
