...
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.pref.BrowsableItemPrefs.SORT_MASK_ALL;
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.pref.BrowsableItemPrefs.SORT_MASK_NAME_RND;
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.util.Utils.getResourceUri;
...
import me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.engine.BitmapCache;
...
import me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.engine.MetadataRetriever;
...
import me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.vfs.FermataVfsManager;
...
public interface MediaLib {
	...
	interface PlayableItem extends Item {
		...
		/**
		 * Extra subtitle tracks provided by the item (e.g. Stremio stream.subtitles /
		 * OpenSubtitles-style addons). Merged into {@link MediaEngine#getSubtitleStreamInfo()}.
		 */
		@NonNull
		default FutureSupplier<List<me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.engine.SubtitleStreamInfo>> getSubtitleStreams() {
