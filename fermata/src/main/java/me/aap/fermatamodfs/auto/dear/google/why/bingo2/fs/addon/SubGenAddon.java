...
public class SubGenAddon implements FermataAddon {
	...
	public void contributeSettings(Context ctx, PreferenceStore ps, PreferenceSet set,
		...
		set.addBooleanPref(o -> {
			o.store = mps;
			o.pref = TRANSLATE;
			o.title = me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.sub_gen_translate;
		...
		set.addButton(o -> {
			o.title = me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.sub_gen_cleanup;
			o.onClick = () -> {
				...
				showInfo(ctx, ctx.getString(me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.sub_gen_cleanup_done, deleted));
			};
			o.visibility = visibility.copy();
		});
	}
	...
	public FutureSupplier<Transcriptor> getTranscriptor(PreferenceStore ps) {
		...
		var ctx = App.get();
		ActivityBase.create(App.get(), "me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.subgen", "subgen",
				me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.drawable.notification, ctx.getString(R.string.downloading, "..."),
