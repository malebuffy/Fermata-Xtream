...
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.pref.MediaLibPrefs.EXO_ENABLED;
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.pref.MediaLibPrefs.VLC_ENABLED;
...
import static me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.pref.MediaPrefs.VIDEO_ENGINE;
...
import me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.ui.activity.MainActivity;
...
public class MediaEngineManager implements PreferenceStore.Listener {
	private static final String EXO_PROV_CLASS =
			"me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.engine.exoplayer.ExoPlayerEngineProvider";
	private static final String VLC_PROV_CLASS = "me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.engine.vlc.VlcEngineProvider";
	...
	public MediaEngine createAuxiliaryEngine(@Nullable MediaEngine primary,
																					 PlayableItem i,
																					 Listener listener) {
		var newEng = i.getMediaEngine(null, listener);
		if (newEng != null) return newEng;
		if (engineProvider != null) return engineProvider.createEngine(listener);
		PlayableItemPrefs pref = i.getPrefs();
