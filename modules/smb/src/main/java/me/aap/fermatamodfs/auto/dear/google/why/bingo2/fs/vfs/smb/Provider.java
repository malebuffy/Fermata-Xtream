package me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.vfs.smb;
...
public class Provider extends VfsProviderBase {
	...
	protected FutureSupplier<? extends VirtualFolder> addFolder(MainActivityDelegate a, VirtualFileSystem fs) {
		...
		prefs.addStringPref(o -> {
			o.store = ps;
			o.pref = SHARE;
			o.title = me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.share_name;
			o.stringHint = "share";
		});
		prefs.addStringPref(o -> {
			o.store = ps;
			o.pref = DOMAIN;
			o.title = me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.domain;
