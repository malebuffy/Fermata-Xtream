package me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.addon.felex.media;
...
import me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.media.lib.PlayableItemBase;
...
public interface FelexItem extends MediaLib.Item {
	...
	class Root extends ItemContainer<FelexItem> implements FelexItem {
		...
		public String getName() {
			return getLib().getContext().getString(me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.R.string.addon_name_felex);
		}
	...
	class Dict extends BrowsableItemBase implements FelexItem {
		private final me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.addon.felex.dict.Dict dict;

		public Dict(DefaultMediaLib lib, me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.addon.felex.dict.Dict dict) {
		...
		public me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.addon.felex.dict.Dict getDict() {
			return dict;
		}
	...
	class Tutor extends PlayableItemBase implements FelexItem {
		...
		public static Tutor create(DefaultMediaLib lib, me.aap.fermatamodfs.auto.dear.google.why.bingo2.fs.addon.felex.dict.Dict dict,
															 DictTutor.Mode mode) {
