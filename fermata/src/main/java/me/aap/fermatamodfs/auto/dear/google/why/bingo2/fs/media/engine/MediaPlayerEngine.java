...
public class MediaPlayerEngine extends MediaEngineBase
	...
	public MediaPlayerEngine(Context ctx, Listener listener) {
		...
		setStableAudioSession(ctx, player);
	...
	private static void setStableAudioSession(Context ctx, MediaPlayer player) {
		...
		try {
			...
			Log.w(ex, "Failed to set MediaPlayer audio session: ", sessionId);
		}
	}
